...
public class DiagramPositionsCollector {
    ...
    public void recordMessage(String leftParticipantCode, String rightParticipantCode, double yPosition, List<String> label) {
    ...
    public static class MessageEvent {
        ...
        private MessageEvent(Direction direction, double position, List<String> label) {
