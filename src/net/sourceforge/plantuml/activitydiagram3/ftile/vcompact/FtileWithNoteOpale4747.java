...
public class FtileWithNoteOpale4747 extends AbstractFtile implements Stencil {
	...
	public FtileWithNoteOpale4747(Ftile tile, Display note, HtmlColor arrowColor, NotePosition notePosition,
		...
		if (OptionFlags.USE_CREOLE) {
			...
			text = new SheetBlock2(new SheetBlock1(sheet, 0), this, new UStroke(1));
		} else {
