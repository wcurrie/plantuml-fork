...
import net.sourceforge.plantuml.activitydiagram3.ftile.vertical.FtileDiamond2;
...
class FtileIf4 extends AbstractFtile {
	...
	private FtileIf4(Ftile diamond1, Ftile tile1, Ftile tile2, Ftile diamond2, HtmlColor arrowColor) {
	...
	static Ftile create(Swimlane swimlane, Ftile tile1, Ftile tile2, HtmlColor borderColor, HtmlColor backColor,
			Display labelTest, Display label1, Display label2, UFont font, HtmlColor arrowColor,
			HtmlColor endThenInlinkColor, HtmlColor endElseInlinkColor, FtileFactory ftileFactory) {

		tile1 = new FtileMinWidth(tile1, 30);
		tile2 = new FtileMinWidth(tile2, 30);

		final FontConfiguration fc = new FontConfiguration(font, HtmlColorUtils.BLACK);
		final TextBlock tb1 = TextBlockUtils.create(label1, fc, HorizontalAlignment.LEFT, new SpriteContainerEmpty());
		final TextBlock tb2 = TextBlockUtils.create(label2, fc, HorizontalAlignment.LEFT, new SpriteContainerEmpty());
		final TextBlock tbTest = TextBlockUtils.create(labelTest, fc, HorizontalAlignment.LEFT,
				new SpriteContainerEmpty());

		final Ftile diamond1 = new FtileDiamond2(tile1.shadowing(), backColor, borderColor, swimlane, tbTest).withWest(
				tb1).withEast(tb2);

		// final Ftile diamond1 = new FtileDiamond(tile1.shadowing(), backColor, borderColor, tile1.getSwimlaneIn())
		...
		final FtileIf4 result = new FtileIf4(diamond1, tile1, tile2, diamond2, arrowColor);
	...
	private UTranslate getTranslate1(StringBounder stringBounder) {
		...
		final double x1 = 0;
		final double y1 = (dimTotal.getHeight() - dimDiamond1.getHeight() * 2 - dim1.getHeight()) / 2
	...
	private Dimension2D calculateDimensionInternal(StringBounder stringBounder) {
		...
		return new Dimension2DDouble(width + 30, dim12.getHeight() + dimDiamond1.getHeight() * 2 + 25);
	}
