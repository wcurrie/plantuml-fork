...
class FtileRepeat2 extends AbstractFtile {
	...
	private FtileRepeat2(Ftile repeat, Ftile diamond1, Ftile diamond2) {
	...
	public static Ftile create(Swimlane swimlane, Ftile repeat, Display test, HtmlColor borderColor, HtmlColor backColor, UFont font,
		...
		final FtileRepeat2 result = new FtileRepeat2(repeat, diamond1, diamond2);
